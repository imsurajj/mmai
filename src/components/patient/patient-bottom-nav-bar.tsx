...
import { LayoutDashboard, Calendar, Bell, Settings } from 'lucide-react-native';
  ...
  return (
    ...
    >
      ...
      <Pressable onPress={() => onSelectTab('home')} style={styles.navTabBtn}>
        <View style={[styles.navTabIconWrap, activeTab === 'home' && styles.navTabActiveCircle]}>
          <LayoutDashboard
            size={20}
        ...
        <Text
          ...
          style={[
            styles.navTabLabel,
            {
              color: activeTab === 'home' ? '#FFFFFF' : 'rgba(255,255,255,0.75)',
      ...
      <Pressable onPress={() => onSelectTab('timeline')} style={styles.navTabBtn}>
        <View style={[styles.navTabIconWrap, activeTab === 'timeline' && styles.navTabActiveCircle]}>
          <Calendar
            size={20}
            strokeWidth={activeTab === 'timeline' ? 2.8 : 1.9}
            color={activeTab === 'timeline' ? '#FFFFFF' : 'rgba(255,255,255,0.7)'}
          />
        </View>
        <Text
          numberOfLines={1}
      ...
      <Pressable onPress={() => onSelectTab('reminders')} style={styles.navTabBtn}>
        <View style={[styles.navTabIconWrap, activeTab === 'reminders' && styles.navTabActiveCircle]}>
          <Bell
            size={20}
            strokeWidth={activeTab === 'reminders' ? 2.8 : 1.9}
            color={activeTab === 'reminders' ? '#FFFFFF' : 'rgba(255,255,255,0.7)'}
          />
        </View>
        <Text
          numberOfLines={1}
          style={[
            styles.navTabLabel,
            {
              color: activeTab === 'reminders' ? '#FFFFFF' : 'rgba(255,255,255,0.75)',
      ...
      <Pressable onPress={() => onSelectTab('settings')} style={styles.navTabBtn}>
        <View style={[styles.navTabIconWrap, activeTab === 'settings' && styles.navTabActiveCircle]}>
          <Settings
            size={20}
        ...
        <Text
          ...
          style={[
            styles.navTabLabel,
            {
              color: activeTab === 'settings' ? '#FFFFFF' : 'rgba(255,255,255,0.75)',
