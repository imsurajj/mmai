...
import { PatientItemTracker } from './patient-item-tracker';
import { PatientLiveMap } from './patient-live-map';
...
export function PatientHomeTab({
  ...
  return (
    <Animated.View entering={FadeInDown.duration(240)} style={styles.container}>
      ...
      <PatientLiveMap patientId={user?.id} />
      ...
      {/* Object Memory & Item Location Tracker */}
      <PatientItemTracker />
