...
export const Button = forwardRef<View, ButtonProps>(
  (
    ...
    const getButtonStyle = (): ViewStyle => {
      ...
      switch (size) {
        case 'sm':
          Object.assign(baseStyle, { height: 44, borderRadius: 22, paddingHorizontal: 24 });
          break;
        case 'lg':
          Object.assign(baseStyle, { height: 54, borderRadius: 27, paddingHorizontal: 36 });
          break;
        case 'icon':
          ...
          break;
        default:
          Object.assign(baseStyle, { height: HEIGHT, borderRadius: 24, paddingHorizontal: 32 });
      }
